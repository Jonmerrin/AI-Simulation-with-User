...
public class Mover{
    ...
    //Things that interact with user
    private boolean knownByUser = false;
    private boolean notice = false;
    private boolean initiative;
    BufferedReader reaction = new BufferedReader(new InputStreamReader(System.in));
    ...
    public boolean getMode(){
        return currentWorld.getMode();
    }

    public void setKnown(boolean intro){
        knownByUser = intro;
    }
    ...
    public boolean rollFor(){
        double initiative = Math.floor(Math.random()*2);
        if(initiative == 0){
            return true;
        }
        else{
    ...
    public void setNotice(boolean g){
        notice = g;
    }
    ...
    public void interact(User guy){
        String choice = null;
        /**
         * Still adding here! This will be the interaction between mover and user!!!
         * Need BufferedReader though.
         */
        if(guy!=null && this!=null){
            boolean didInteract = false;
            didInteract = true;
            ...
            action.interact(this, guy);
            try{
                System.out.println("What would you like to do in return?\n\n");
                System.out.println(action.listResponses(action.getOption(), name));
                choice = reaction.readLine();
            }
