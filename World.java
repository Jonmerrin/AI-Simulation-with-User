...
public class World {
    ...
    public void setMode(boolean tf2){
        mode = tf2;
    }
    ...
    //adds a User to the list of people.
    //     public void addMover(User guy){
    //         people.add(guy);
    //     }
    // 
    //     //removes a User from the list of people, and puts their name back into the random names pool.
    //     //Used in case of changing modes.
    //     public void removeMover(User guy){
    //         people.remove(guy);
    //         charNames.add(guy.getName());
    //     }
    ...
    public void moveAll(){
        ...
        for(int z=0; z<this.getPeople().size(); z++){
            if(!this.getPeople().get(z).getTag().equals("user")){
